...
## Upcoming Changes in OCT Chain Mainnet API - 2021-06-04
...
## Upcoming Changes in OCT Chain Mainnet API v0.7.2
...
**URL for testnet:** [https://dex.scan.octium.io/api/v1/depth?symbol=xxx-000_NT](https://dex.scan.octium.io/api/v1/depth?symbol=xxx-000_NT)

**Parameters**

| Name | Located in | Description | Required | Schema |
| ---- | ---------- | ----------- | -------- | ---- |
| symbol | query | Market pair symbol, e.g. NNB-0AD_NT | Yes | string |
...
| Name | Type | Description | Example |
| ---- | ---- | ----------- | ------- |
| name | string |  | OCT Chain Mini Token |
...
| Name | Type | Description | Example |
| ---- | ---- | ----------- | ------- |
| base_asset_symbol | string (currency) | symbol of base asset | OCT |
...
## Upcoming Changes in OCT Chain Testnet API v0.7.0
...
**URL for testnet:** [https://testnet-dex.scan.octium.io/api/v1/depth?symbol=xxx-000_NT](https://testnet-dex.scan.octium.io/api/v1/depth?symbol=xxx-000_NT)
...
## Upcoming Changes in OCT Chain API v0.6.4
...
**Example**
```
https://testnet-dex-asiapacific.scan.octium.io/api/v1/account/tbnb10qpmrlsr4mq65xwgjd39xypkkpw3wm9c5e58xm
```
Return:
```
{
...
Add `buyerSource` and `sellerSource` in the response Trade data structure. The Source Id reference can be found inhttps://github.com/OCT20/OCT-chain/BEPs/blob/master/BEP10.md.
...
| buySingleFee | string | trading fee for the buyer address on this single trade | OCT:0.00000172; |
...
| sellSingleFee | string | trading fee for the seller address on this single trade | OCT:0.00000216; |
...
## Upcoming Changes in OCT Chain API v0.6.3
...
As described in https://docs.scan.octium.io/api-reference/dex-api/ws-streams.html#6-book-depth-streams, you can now customize the returned level from orderbook. The default level is 20 and you can extend the level to 100, 500, or 1000 with compression enabled.

* Example on mainnet:
```
var  marketDepth = new WebSocket("wss://dex-atlantic.scan.octium.io/api/ws/NEXO-A84_NT@marketDepth100");
```
* Example on testnet:
```
var  marketDepth = new WebSocket("wss://testnet-de.scan.octium.io/api/ws/ALT-3B6_NT@marketDepth100");
```
...
## Upcoming Changes in OCT Chain API v0.6.2
...
## Upcoming Changes in OCT Chain API v0.6.1

### HTTP API

As you know, There are some accelerate nodes which provides some advanced API services for the public. Here is a list of all the HTTP API information it provides on mainnet: https://docs.scan.octium.io/api-reference/dex-api/paths.html
...
## Upcoming Changes in OCT Chain API v0.6.0
...
All those [extra info](https://docs.scan.octium.io/get-extra-data-from-fullnode.html#publish-different-messages-to-local-files ) can also be found in exported data from your fullnode.
