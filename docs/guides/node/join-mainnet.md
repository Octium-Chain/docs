...
!!! Tip
    See the [node-binary repo](https://github.com/OCT20/OCT-chain/node-binary/blob/master/README.md) for information on the mainnet, including the correct version of the binaries to use and details about the genesis file.
...
* Your full node has to run at least 4 hours per 24 hours in order to catch up with OCT Chain More hours will be better, run your node continuously for best results.

## Setting Up a New Node
> You can skip this part if you have executed the install script.

First you need to choose a home folder `$BNCHOME` (i.e. ~/.bnbchaind) for OCT Chain.
...
If those seeds aren't working, you can find more seeds and persistent peers in HTTP API endpoints: https://dex.scan.octium.io/api/v1/peers
...
* [Explorer](https://explorer.scan.octium.io/)
