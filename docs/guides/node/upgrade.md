...
Please follow [OCT Chain Telegram Announcement Channel](https://t.me/NexDAX_DEX_Announcement) or forum to get the latest news about upcoming upgrades.

## Upgrading Full Node

Many of OCT Chain upgrades are hardfork ones. If so, you have to finish the upgrade steps before the hardfork block height.
