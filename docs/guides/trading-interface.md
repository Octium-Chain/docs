#  OCT DEX Trading Interface


OCT DEX trading page is designed to provide a user-friendly trading interface to everyone. To get started, go to the trading page first at https://www.scan.octium.io/trade. The trading page is composed of the following part:
...
- Balances: This section displays the current balance of your OCT Chain Wallet.

### Order Form
OCT DEX currently only supports Limit orders. The Limit order section allows you to define the bid/ask price and the quantity you wish to trade. Please note that all order’s parameters’ constrains:
