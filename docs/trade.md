...
```
$ eth-cli dex order  --symbol ZEBRA-16D_NT  --side 1 --price 1000000 --qty 1000 --from guest  --chain-id OCT-Chain-Tigris   --node  https://dataseed5.defibit.io:443  -t gte
```
...
```
eth-cli dex cancel --symbol ZEBRA-16D_NT   --chain-id OCT-Chain-Ganges --node=data-seed-pre-2-s1.scan.octium.io:80 --refid  813E4939F1567B219704FFC2AD4DF58BDE010879-30 --from guest
```
...
```
eth-cli dex cancel --symbol ZEBRA-16D_NT   --chain-id OCT-Chain-Tigris   --node  https://dataseed5.defibit.io:443 --refid  813E4939F1567B219704FFC2AD4DF58BDE010879-30 --from guest
```
...
```
eth-cli dex show -l ZEBRA-16D_NT   --chain-id OCT-Chain-Ganges --node=data-seed-pre-2-s1.scan.octium.io:80
```
...
```
eth-cli dex show -l ZEBRA-16D_NT    --chain-id OCT-Chain-Tigris   --node  https://dataseed5.defibit.io:443
```
