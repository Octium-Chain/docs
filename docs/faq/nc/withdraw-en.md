...
## Background
Since OCT Chain and Ethereum follow the same address generation algorithm. In some cases, users may mistakenly choose the wrong network type when withdrawing tokens to OCT Chain network. 
...
- Then you have to deposit to OCT.com again. Please note you have to choose the ERC20 type for deposit