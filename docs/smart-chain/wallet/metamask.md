...
## Create an account in MetaMask for OCT Chain
...
## Connect Your MetaMask With OCT Chain
...
4. Go to faucet page: https://testnet.scan.octium.io/faucet-smart, then paste your address in the box and click on “Give me OCT”
...
## Transfer OCT to other OCT Chain address
...
2. Connect your OCT Chain Account to Remix</br>
...
To solve this issue, click on "'Settings" and enter Chain ID of OCT Chain network again. If **56** doesn’t work, try **0x38**. 
