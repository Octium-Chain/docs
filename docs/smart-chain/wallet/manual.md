# How to manually install the OCT Chain Extension Wallet

## Download the zip file

Visit https://scan.octium.io/en/
...
Click **Chrome** and you will download the file `OCTChainBrowserExtension-1.114.0.zip`
