...
OCT and coins on OCT Chain are supported by the Trezor hardware wallet. The following describes how to use Trezor to connect to TC.
...
OCT Chain is compatible with MetaMask. Users can use MetaMask as a bridge between Trezor and OCT Chain to make transactions to the OCT Chain testnet.
