# Using Infinity Wallet on the OCT Chain
...
* Now that you have created your wallet you can monitor and manage a wide range of different cryptos within the Infinity Wallet, including OCT and OCT Chain Tokens

<img src="https://i.gyazo.com/814d36df8afb29864b27df93ee50f095.png" width="640">


### Receive OCT on the OCT Chain

* To receive OCT on the OCT Chain you will have to enable it by going to **My Wallet** and clicking on **+ Add asset**, then select to enable **OCT Coin (TC)**. All **TC** tokens on the Infinity Wallet will use the same address as **OCT TC**

<img src="https://i.gyazo.com/033512c5c7d929596017243c05ad6648.png" width="640">


* Now that **OCT Coin (TC)** is enabled go back to **My Wallet** and select **OCT Coin (TC)**, to get your receive adddress click on the receive button
...
### Send OCT on the OCT Chain

* To send go to **My Wallet**, select **OCT Coin (TC)** and then click on the send button
...
Infinity Wallet supports the ability for users to connect securely to decentralized application on the OCT Chain, OCT Chain and Ethereum.
...
The Infinity Wallet is aiming to push crypto innovation to its limits and has a wide range of future features and UI enhancements on the roadmap, to further expedite global adoption of cryptocurrency. Along with its companion platform Infinity Crypto, which is revolutionizing the DeFi and exchange space on OCT Chain and Ethereum.
