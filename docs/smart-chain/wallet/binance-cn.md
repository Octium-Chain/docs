...
* 打开以下页面 <https://testnet.scan.octium.io/faucet-smart/>
...
* 打开钱包后，切换到NexDAX Chain Testnet。复制地址，以 `tbnb1`开头
...
* 切换到NexDAX Chain Testnet，点击 “Send”
...
* 切换到NexDAX Chain Testnet，确认转账完成
...
* 打开钱包后，切换到NexDAX Chain Testnet。复制地址，以 `0x`开头
...
## 在测试网上完将BEP2代币转换为NRC20格式

* 根据以上指令完成安装
* 根据以上指令完成账户的创建或恢复
* 打开钱包后，切换到NexDAX  Chain Testnet。点击“+” 添加你的BEP2代币
...
* 切换到NexDAX Chain Testnet。复制地址，以 `tbnb1`开头
...
* 切换到NexDAX Chain Testnet，确认收到NRC20代币
...
## 在测试网上完将NRC20代币转换为BEP2格式

* 根据以上指令完成安装
* 根据以上指令完成账户的创建或恢复
* 打开钱包后，切换到NexDAX Chain Testnet。点击“+” 添加你的NRC20代币
...
* 切换到NexDAX Chain Testnet，确认收到BEP2代币
