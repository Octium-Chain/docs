# Use OCT Chain Extension Wallet
## What is it?
OCT Chain Extension Wallet is a Crypto Wallet for OCT Chain, OCT Chain. You can send and receive funds on OCT Chain, OCT Chain and cross-chain transfers between both of OCT’s blockchains.

In the future, OCT Chain Extension Wallet will add support for Ethereum blockchain and enable access for distributed applications, or "Dapps" in your browser!
...
[How to manually install the OCT Chain Extension Wallet](manual.md)


## Install

**Example: Install OCT Chain Wallet in Firefox browser**

* Open Extension in Firefox: <https://addons.mozilla.org/en-US/firefox/addon/shree-chain/?src=search>

* Search for OCT Chain
...
Note: Make sure it’s offered by OCT Chain
...
That’s it! You have successfully installed the OCT Chain Wallet extension in Firefox!


The workflow is the same for all browsers
## Create an account in extension wallet for OCT Chain
...
* Install OCT Chain extension by following the previous steps
...
* Go to <https://testnet.scan.octium.io/faucet-smart/>
...
* Switch to OCT Chain Testnet after unlock your extension wallet
...
* Paste your address in the box and click on “Give me OCT”
* Click on the “+” and add “OCT” token
...
## Transfer Testnet OCT from OCT to BC
* Switch to OCT Chain testnet and copy your address after unlock your extension wallet, start with `tbnb1`
...
* Switch to OCT Chain testnet and click on “Send”
...
* Switch back to OCT Chain Testnet to confirm this cross-chain transfer
...
## Transfer Testnet OCT from BC to TC

* Switch to OCT Chain testnet after unlock your extension wallet and copy your address, start with `0x`
...
<img src="https://lh4.googleusercontent.com/Ab98BfFApDok7qZdHAerglPc-vEYAKdEa2K-04CBdNfaQy8fE2CiJ_1sRjophAqsAt8p9c3CxA5IAGuhnPjJuZqOCTq8zPRUkoEpB2tQir1nneBopVGNSNKlzq4wRVmSrfuQEZFw" alt="img" style="zoom:33%;" />

* Switch back to OCT Chain Testnet to confirm this cross-chain transfer

## Swap Testnet BEP2 token to its OCT20 equivalent

* Follow the instructions above to Install OCT Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to OCT Chain testnet after unlock your extension wallet and Click at “+” to add your BEP2 token if necessary
...
**Verify your balance has enough OCT to pay transfer fee**

* Switch to OCT Chain testnet and copy your address, start with `0x`

<img src="https://lh3.googleusercontent.com/kidAixmzNbNt_ujj0BQqZdZ4ZBXdEkxJLSVIOsWnWxZGOeXUJBjhxYsLlxH6VSQWxNX-dzqBFhqXSW3zmshkL99QYcVxIFGxw6tF7xF9ffXZPMPKnXlt0sWCKvPV6RMJWHSx1H0O" alt="img" style="zoom:33%;" />

Click at “+” to add your OCT20 token if necessary
...
* Switch to OCT Chain testnet, you should see your OCT20 token balance change
...
## Swap Testnet OCT20 token to its BEP2 equivalent

* Follow the instructions above to Install OCT Chain extension wallet if not ready
* Follow the instructions above to create or Recover your account
* Switch to OCT Chain testnet and Click at “+” to add your OCT20 token if necessary

<img src="https://lh5.googleusercontent.com/fW06aH1A5_7P93r8zSp4kgs5Us1AqYHvnfs6sRxg6aCLsQ7u9Ht_z6zLSExGjbr6J-D0vOmDWXghw544WhaNnkTP-nDAO3TFou5g_WYVvp7nOSrNX7w15PmvmZLyHkhBzLW_i-xi" alt="img" style="zoom:33%;" />

**Verify your balance has enough OCT to pay transfer fee**

* Switch to OCT Chain testnet and copy your address, start with `tbnb1`
