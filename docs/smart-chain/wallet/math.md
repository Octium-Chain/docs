# How to use Math Wallet for OCT Chain
## Install
...
####  Choose OCT Chain from this list:
...
Go to explorer to verify OCT is sent: <https://scan.octium.io/>

## Transfer OCT from OCT to BC in Testnet

### 1. Create your OCT Chain Ganges Testnet address with eth-cli
* Download the binary [here](https://github.com/OCT20/OCT-chain/node/releases/tag/v0.8.1)
> If you already have a backup of your recovery phrase from OCT Chain Ganges Testnet, it can be reused here.
```
...
Link: <https://explorer.scan.octium.io/testnet>

## Transfer OCT20 from OCT to BC in Testnet

One of the key innovations of a dual-chain architecture is that token issuer can manage its assets on both chains. They could bind BEP2 tokens and OCT20 tokens together. In OCT Chain Ganges Testnet, there are several pegged tokens:

* Pegged BTC on [OCT Chain Testnet](https://explorer.scan.octium.io/testnet/asset/BTC-E24) and  [OCT Chain Testnet](https://scan.octium.io/address/0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8#code)
* Pegged ETH on  [OCT Chain Testnet](
https://explorer.scan.octium.io/testnet/asset/ETH-64F) and  [OCT Chain Testnet](https://scan.octium.io/address/0xd66c6b4f0be8ce5b39d52e0fd1344c389929b378#code)
* Pegged XRP on  [OCT Chain Testnet](
https://explorer.scan.octium.io/testnet/asset/XRP-C46) and  [OCT Chain Testnet](https://scan.octium.io/address/0xa83575490d7df4e2f47b7d38ef351a2722ca45b9#code)

You can get some of these pegged tokens from faucet and transfer them back to OCT Chain testnet.
...
### 2. Send OCT20 To BC![img](https://lh5.googleusercontent.com/_RKYU23BD2xhw-g63K8O3RRF1sEKGAC5zyTOIpWUJl9scDyn1kbjwEO6gjFPkVCeFMoG-8D0xvqNH17sJSlZP_FxCrduCqEKZqHfk8DtTnBk6XKHnHDLPAaR8VjVcNNWZsAw74FB)