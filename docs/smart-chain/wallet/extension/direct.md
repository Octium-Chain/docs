# [Wallet Direct](https://www.scan.octium.io/en/wallet-direct) User Guide

## Key Features
- Seamless Token Transfer
Transfer tokens (which support BC/TC) between paired OCT.com account and OCT Chain Wallet. Without the trouble of copy/paste address and memo every time
- OCT Holding
The OCT  positions of your OCT.com account will not change.
...
## User Guide
### Prerequisites
- OCT.com Account SetupEnable two-factor authentication for your OCT.com account (The balance cannot be zero)
- Install OCT Chain Extension WalletInstall the latest **v1.126.11** :
...
Click on “Connect to OCT.com account”
...
The connected address display on this page: https://www.scan.octium.io/en/wallet-direct 
...
- Unpair from [OCT.com](https://www.scan.octium.io/en/wallet-direct)

<img src="https://lh4.googleusercontent.com/78UWTlOflzaiSipnOEoc0wKzl1x_4-si4QG-v4XWl3rf1-tFcV5Ug35PcwVS3Rgorabnee5KtZuOwTZKn0k-UBduTqQJEDJK2A-BSMxmNyDobvqvNOktLj5xB9tpg3d-1zd5UrBd" alt="img" style="zoom:33%;" />



Go to this page: https://www.scan.octium.io/en/wallet-direct and click on “Disconnect‘, then your address is not connected anymore.
...
- Unpair from your OCT Extension wallet 
...
### How to Withdraw Tokens from OCT.com to a paired account in Extension wallet?

1. Unlock your pairs account of OCT Extension wallet
...
3. Select one of your assets from the account balance of OCT.com
...
### How to Deposit Tokens from your OCT Extension wallet account to a paired OCT.com account?
