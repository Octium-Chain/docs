# How to Verify Your Contract on scan.octium.io

## Step 1: Deploy your contract on OCT Chain

## Step 2: Go to [NCExplorer](https://scan.octium.io/) or [Testnet Explorer](https://testnet.scan.octium.io/)
...
!!! info
	...
	The default OCT20 contract template does not have a constructor method
