...
Deploys a OCT20 smart contract with a message, and renders it in the front-end. You can interact with the smart contract easily!
...
- Create new contract NRC20Token.sol and copy contract code from the bep20 token template [here](../NRC20Token.template)
...
Now, We have to deploy our smart contract on OCT Chain Network. For that, we have to connect to web3 world, this can be done my many services like Metamask, Brave, Portis etc. We will be using Metamask. Please follow this [tutorial to setup a Metamask Account](../../wallet/metamask.md).
...
* Testnet
        ...
        * ChainID: 11512
        * Symbol: OCT
        * Block Explorer: https://testnet.scan.octium.io

* Mainnet
        * [RPC URLs](../rpc.md)
        * ChainID: 11513
        * Symbol: OCT
        * Block Explorer: https://scan.octium.io


- Go ahead and click save
- Copy your address from Metamask

- Head over to [Faucet](https://testnet.scan.octium.io/faucet-smart) and request test OCT

- Now, let's Deploy the Smart Contract on OCT Chain Testnet
...
**Congratulations!** You have successfully deployed a OCT20 Contract. Now you can interact with the Smart Contract. Check the deployment status here: <https://testnet.scan.octium.io/>
