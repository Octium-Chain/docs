# Local OCT Chain Network

See also : [https://github.com/ethereum/go-ethereum/wiki/POCTate-network](https://github.com/ethereum/go-ethereum/wiki/POCTate-network)


## Setting up your OCT Node(s)
