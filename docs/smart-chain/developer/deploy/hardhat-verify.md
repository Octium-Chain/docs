...
Go to register and get API key: <https://testnet.scan.octium.io/myapikey>
...
module.exports = {
  ...
  networks: {
    testnet: {
      url: `https://testnet-rpc.scan.octium.io`,
      accounts: {mnemonic: mnemonic}
    },
    mainnet: {
      url: `https://nc-dataseed.scan.octium.io/`,
      accounts: {mnemonic: mnemonic}
    }
  },
  ...
  etherscan: {
    ...
    // Obtain one at https://testnet.scan.octium.io/
...
https://testnet.scan.octium.io/address/0xbF39886B4F91F5170934191b0d96Dd277147FBB2#code
```