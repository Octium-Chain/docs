...
*Please learn how to deploy an upgradable OCT20 contract [here](./proxy.md)*
...
- Create new contract proxy.sol and copy contract code from flattened `NRC20UpgradeableProxyFlattened.sol `.  Here is and [example](https://scan.octium.io/address/0xA6Ec2Fe4F6040b188A926048f44c9A59Fca189d4#code)
...
**Logic**: The address of `NRC20Implementation` contract
**Admin**: admin cannot be OCT20 token owner
