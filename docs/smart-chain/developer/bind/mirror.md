# Mirror BEP2 and OCT20 Token

## Prerequisite

This OCT20 token is not bond to any BEP2 token

## Motivation

Anyone can call the `mirror` [method](https://github.com/OCT20/OCT-chain-genesis-contract/blob/af4f3993303213052222f55c721e661862d19638/contracts/TokenManager.sol#L331) to issue a BEP2 token automatically and bind them.

## What happens under the hood

- Verify there is no pending mirror request
- Check the total supply and token symbol is valid
- Send a cross-chain package to issue a BEP2 token on OCT Chain
...
| Fee Name    | Pay in OCT |
| ----------- | ---------------------------- |
| mirrorFee   | it's 10 OCT on mainnet now   |
...
- Select `mirror` function and fill-in with your OCT20 address
