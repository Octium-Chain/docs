# DIA Data Oracles on OCT Chain

## Introduction

DApp developers who want to leverage DIA oracles can access the published data on OCT Chain. DIA offers cryptocurrency and data about traditional financial assets.
...
|              WNT on PancakeSwap           |  Chart Point on Exchange |
...
The following snippet shows how to retrieve the BTC price of an asset (e.g. `OCT Coin`) using a smart contract.
