# Band Protocol Price Feed on OCT Chain

## Introduction

Developers building on OCT Chain can now leverage Band’s decentralized oracle infrastructure. With Band’s oracle, they now have access to various cryptocurrency price data to integrate into their applications.
...
Currently, there are two methods for developers to query prices from Band’s oracle: through Band’s `StdReference` smart contract on OCT Chain and through their [`bandchain.js`](https://www.npmjs.com/package/%40bandprotocol%2Fbandchain.js) JavaScript helper library.
...
For example, if we call `getReferenceDataBulk` with `['BTC','BTC','ETH']` and `['USD','ETH','OCT']`, the returned `ReferenceData` array will contain information regarding the pairs:
...
| :------------ | :------------------------------------------: | :----------: | :----------------------------------------------------------: |
| OCT (Testnet) | `0xDA7a001b254CD22e46d3eAB04d937489c93174C3` |    5 mins    | [link](https://tesnet.scan.octium.io/address/0xDA7a001b254CD22e46d3eAB04d937489c93174C3) |
| OCT (Mainnet) | `0xDA7a001b254CD22e46d3eAB04d937489c93174C3` |    5 mins    | [link](https://scan.octium.io/address/0xDA7a001b254CD22e46d3eAB04d937489c93174C3) |
