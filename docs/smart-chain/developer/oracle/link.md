# OCT Chain Price Feeds from Chainlink
...
Often, smart contracts need to act upon prices of assets in real-time. This is especially true in [DeFi](https://defi.chain.link/). For example, [Synthetix](https://www.synthetix.io/) use Price Feeds to determine prices on their deOCTatives platform. Lending and Borrowing platforms like [AAVE](https://aave.com/) use Price Feeds to ensure the total value of the collateral.

## Get the Latest Price

This section explains how to get the latest price of OCT inside smart contracts using Chainlink Price Feeds, on the OCT Chain.
...
web3 = Web3(Web3.HTTPProvider('https://testnet-rpc.scan.octium.io'))
...
Chainlink price feed contracts are updated on a regular basis by multiple Chainlink nodes. This section lists the contract addresses for Price Feeds on the OCT Chain.

### Mainnet

| Pair      | Proxy                                                        |
| :-------- | :----------------------------------------------------------- |
| OCT / USD | [`0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE`](https://scan.octium.io/address/0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE) |
| BTC / USD | [`0x264990fbd0A4796A3E3d8E37C4d5F87a3aCa5Ebf`](https://scan.octium.io/address/0x264990fbd0A4796A3E3d8E37C4d5F87a3aCa5Ebf) |
| ETH / USD | [`0x9ef1B8c0E4F7dc8bF5719Ea496883DC6401d5b2e`](https://scan.octium.io/address/0x9ef1B8c0E4F7dc8bF5719Ea496883DC6401d5b2e) |
