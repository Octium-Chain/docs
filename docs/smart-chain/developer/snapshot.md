...
* [Latest Snapshot](https://github.com/OCT20/OCT-chain)

The following commands are step by step instructions for OCT node operators that can be used for two major use-cases:
...
```
wget --no-check-certificate --no-proxy 'https://github.com/OCT20/OCT-chain'
```
