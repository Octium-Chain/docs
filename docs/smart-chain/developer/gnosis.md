#  Gnosis Safe Multisig on OCT Chain
...
Today, you can set up the Gnosis Safe Multisig on OCT Chain in less than 60 seconds, and you can use wallets including Ledger, Trezor,  Wallet Connect, Torus, and browser wallets like Metamask as signing keys so that you can manage your crypto collectively and inter-operably.
