...
## Delegate with OCT Extension Wallet

Detailed user guide is [here](../wallet/staking.md)

### Create an account if necessary

Please refer to this guide on [how to create a wallet](../wallet/shree.md) with OCT Extension Wallet
...
### Swtich to OCT Chain Network

If you are using OCT Chain, please follow these steps to switch network:
...
## Delegate with OCT Chain Command line
...
Fee for `Delegate Smart Chain Validator`is **0.001NT**
...
```bash
## mainnet
eth-cli staking side-top-validators --top 10 --side-chain-id=bsc --chain-id=OCT-Chain-Tigris

## testnet
eth-cli staking side-top-validators --top 10 --side-chain-id=chapel --chain-id=OCT-Chain-Ganges
```

## Delegate OCT

You can use `eth-cli` or `eth-cli` to [delegate](../../guides/concepts/bc-staking.md#delegate-bnb) some of OCT to a validator
...
You can use `eth-cli`or `eth-cli` to [undelegate](../../guides/concepts/bc-staking.md#undelegate-bnb) some bonded OCT from a validator

## Redelegate OCT

You can use `eth-cli`or `eth-cli` to [redelegate](../../guides/concepts/bc-staking.md#redelegate-bnb) some bonded OCT from a validator
