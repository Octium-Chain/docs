...
This document explains how the genesis file of the OCT Chain is structured.
...
Genesis Link for mainnet:  <https://github.com/OCT20/OCT-chain>
...
In OCT Chain, this value is always set to 0x0.
...
This default wallet would use a similar way to generate keys as Ethereum, i.e. use 256 bits entropy to generate a 24-word mnemonic based on BIP39, and then use the mnemonic and an empty passphrase to generate a seed; finally use the seed to generate a master key, and deOCTe the pOCTate key using BIP32/BIP44 with HD prefix as "44'/60'/", which is the same as Ethereum's deOCTation path.
