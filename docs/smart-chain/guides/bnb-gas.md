...
When users swap their tokens to the OCT20 equivalents on OCT Chain, they also need to get some OCT to pay for gas.

## Requirements

* The destination network has to be **OCT Chain**
* The token is a popular BToken, such as BTC, ETH, USDT, BUSD
* The total of your swap order has to be greater than **2NT**

### How many OCT you can get?

There are 3 options: 0.5 OCT, 1NT and 2 OCT
...
### 2. Check the box "I want to swap some OCT gas in this order"
...
The network fee should be the sum of the fee for swapping assets and the fee for purchasing OCT on your behalf.
...
Received token  = Input amount  - network fee - cost to buy OCT
