# Trezor User Guide
This guide will show you how to use your [Trezor Model T](https://shop.trezor.io/product/trezor-model-t) hardware wallet with OCT Chain and OCT DEX.
...
## Requirements
In order to use a Trezor with OCT Chain and OCT DEX, you will need:
...
1. Open OCT Chain web wallet <www.scan.octium.io>, then go to [unlock page](https://www.scan.octium.io/en/unlock). You should see that Trezor is already an option for you.
...
3. Export OCT address for account #1
...
> Please note that Trezor only supports the OCT Chain mainnet
...
## How to trade OCT Chain crypto assets
